...
**二项队列** (binomial queue) 是若干堆序树的集合，称作**森林** (forest)。堆序树中的每一棵都是有约束的形式，称作**二项树** (binomial tree)。每一个高度上至多存在一棵二项树。高度为 $0$ 的二项数是一棵单节点树，高度为 $k$ 的二项树 $B_{k}$ 通过将一棵二项树 $B_{k - 1}$ 接到另一棵二项树 $B_{k - 1}$ 的根上构成。下图展示了 $B_{0}, B_{1}, B_{2}, B_{3}, B_{4}$。

<div style="text-align: center; margin-top: 0px;">
<img src="https://raw.githubusercontent.com/VictorWang712/Note/refs/heads/main/docs/assets/images/computer_science/advanced_data_structure/chapter_3_1.png" width="70%" style="margin: 0 auto;">
</div>
...
两棵相同高度的二项树的合并是容易的，只需要将较大的根作为子节点街道较小的根上即可，故单次合并仅需常数时间。
